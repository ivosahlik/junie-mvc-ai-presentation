...
# Junie Prompts
Inspect the file `prompts/front-end-guide/requirements-prompt-draft.md`. Use this file to create a developer guide to
...
Write the improved guide to `prompts/front-end-guide/requirements.md`.
